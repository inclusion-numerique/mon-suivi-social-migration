...
ALTER TABLE "directus"."beneficiary" ADD main_income_type_enum json NULL;
...
ALTER TABLE "directus"."beneficiary" ADD major_children_main_income_type_enum json NULL;
...
ALTER TABLE "directus"."beneficiary" ADD partner_main_income_type_enum json NULL;
